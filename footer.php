		...
		<div class="container">
			<div class="footer-wrapper">
				...
				<div class="footer__list footer__categories">
					...
					<!-- ul.footer__ul>li.footer__item*8>a.footer__link[href=#] -->
					<ul class="footer__ul">
				...
				<div class="footer__social-network">
					...
					<div class="footer__social-links">
						<!-- a.footer__link*3[href=#]>img.footer__icon -->
				...
				<div class="footer__contact-details">
					...
					<ul class="footer__ul">
						...
						<li class="footer__item footer__item--mb-2">
							<div class="footer__icon-wrapper">
								<img src="img/footer-phone.svg" alt="Icon: phone" class="footer__icon">
							</div>
							<!-- /.footer__icon-wrapper -->
				...
				<div class="footer-bottom footer__bottom">
					...
					<div class="footer__payment-methods">
						<img src="img/payment-methods.jpg" alt="Image: payment methods">
					</div>
